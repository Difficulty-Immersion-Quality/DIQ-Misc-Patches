...
local PLACEHOLDER_STATUS_TO_APPLIED_STATUS = {
    ...
    ['CHT_RADORB_MARKOHESHKIR_PLACEHOLDER'] = 'MAG_RADIANT_RADIATING_ORB', -- Addition to original
...
local function HandlePlaceholderStatusApplied(target, status, source)
    ...
    elseif statusToApply == 'MAG_RADIANT_RADIATING_ORB' then                
        Osi.ApplyStatus(target, 'MAG_RADIANT_RADIATING_ORB', 12, 0, source)
        Osi.ApplyStatus(target, 'MAG_RADIANT_RADIATING_ORB_DURATION_TECHNICAL ', 6, 0, source)
    end
